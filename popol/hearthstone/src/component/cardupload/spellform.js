...
function Spellform(props) {
  return (
    <div>
      ...
      <FormControl sx={{ minWidth: 100 }}>
        <InputLabel id="age-label">속성</InputLabel>
        <Select
          labelId="age-label"
          id="age-select"
        ...
        >
          ...
          <MenuItem value={"비번"}>비전</MenuItem>
          <MenuItem value={"화염"}>화염</MenuItem>
          <MenuItem value={"냉기"}>냉기</MenuItem>
          <MenuItem value={"자연"}>자연</MenuItem>
          <MenuItem value={"신성"}>신성</MenuItem>
          <MenuItem value={"암흑"}>암흑</MenuItem>
          <MenuItem value={"지옥"}>지옥</MenuItem>
        </Select>
      </FormControl>
